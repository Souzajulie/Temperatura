...
#define TOPICO_SUBSCRIBE "feau/temperatura"     //tópico MQTT de escuta. 
...
{     
  ...
  String myString = "";     // empty string
     ...
     //MQTT.publish(TOPICO_SUBSCRIBE, temperatura);
  ...
  if(tempC != DEVICE_DISCONNECTED_C) 
  {
    ...
    Serial.println(tempC);
     //sprintf(msg, "%2.1", msg);
     dtostrf(tempC, 4, 2, msg); //4 is mininum width, 2 is precision
